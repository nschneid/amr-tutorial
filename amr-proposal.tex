...
and is practical for statistical NLP \citep{schneider-thesis}. 
...
For most of these projects, he led the efforts to formalize the annotation scheme, 
developed annotation guidelines and workflows, and supervised annotators.
